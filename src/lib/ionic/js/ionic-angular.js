 ...
 *   where, when an element is interchanged as scrolling, its img will still have the old src
...
var ONE_PX_TRANSPARENT_IMG_SRC = 'data:img/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7';
 ...
 * view the ability to specify its own custom title element, such as an img or any HTML,
 ...
 * For an HTML title, such as an img, see {@link ionic.directive:ionNavTitle} instead.
