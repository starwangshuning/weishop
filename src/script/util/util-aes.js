/*
 @part first
 @author wangshuning
 @from CryptoJS v3.1.2  rollups/aes.js
 */
...
/*
 @part second
 @author wangshuning
 @from CryptoJS v3.1.2 components/mode-ecb-min.js
 */
...
/*
 @part third
 @description  public function for external called
 */
var AesUtil = {
    //编码
    encodeAesString: function (data, key) {
    ...
    //解码
    decodeAesString: function (encrypted, key) {
        var key       = CryptoJS.enc.Utf8.parse(key);
